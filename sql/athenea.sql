CREATE DATABASE IF NOT EXISTS `ATHENEA` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `ATHENEA`;
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
-- Host: localhost    Database: spring-mybatis-grades
-- ------------------------------------------------------
...
-- Dump completed on 2017-06-19 17:57:12
